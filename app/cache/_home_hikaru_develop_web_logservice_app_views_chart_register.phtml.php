...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <i class="fa fa-bar-chart-o"></i> Register User Chart By <?php echo $range; ?>
                </li>
            </ol>
        </div>
    </div>
    ...
    <div class="ActionLine form-group">
        <form name="drawForm" id="drawForm" method="post" action="/admin/register/draw">
        ...
        <div class="col-lg-12">
            <div class="panel panel-green">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Register User Graph</h3>
                </div>
