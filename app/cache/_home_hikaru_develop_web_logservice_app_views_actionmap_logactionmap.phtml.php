...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <i class="fa fa-wrench"></i> Log Action Map
                </li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 actionMapFrame" name="<?php echo $v->action; ?>">
            <h2><?php echo $v->action; ?> <span class="amview hright"><button type="button" class="btn btn-sm btn-primary goamedit">Edit</button></span><span class="amedit hright"><button type="button" class="btn btn-sm btn-primary addkey">Add Key</button>&nbsp;<button type="button" class="btn btn-sm btn-primary goamsave">Save</button>&nbsp;<button type="button" class="btn btn-sm btn-danger canceledit">Cancel</button></span></h2>
